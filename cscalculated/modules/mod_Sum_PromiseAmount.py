...
def Sum_PromiseAmount(session):
    ...
    try:
        ...
        for i in gbu_data:
            session.add(PCC_GBUAGG_DATA(GBU_ID=i.GBU_ID, SUM_PROMISEAMT_GBU=i.sum_promise_amount))
    ...
    try:
        ...
        for i in grp_data:
            session.add(PCC_COMPGAGG_DATA(Group_ID=i.Group_ID, SUM_PROMISEAMT_GBU=i.sum_promise_amount))
    ...
    try:
        ...
        for i in leg_data:
            session.add(PCC_ENTITYAGG_DATA(Entity_ID=i.Entity_ID, SUM_PROMISEAMT_GBU=i.sum_promise_amount))
    ...
    try:
        ...
        for i in crp_data:
            session.add(PCC_CORPAGG_DATA(Corp_ID=i.Corp_ID, SUM_PROMISEAMT_GBU=i.sum_promise_amount))
    ...
    try:
        ...
        for i in cst_data:
            session.add(PCC_CUSTAGG_DATA(Customer_ID=i.Customer_ID, SUM_PROMISEAMT_GBU=i.sum_promise_amount))
