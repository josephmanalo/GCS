...
def Count_BarredSubscription_CorpCustomer(session):
    """
    ...
    try:
        ...
        for i in gbu_data:
            session.add(PCC_GBUAGG_DATA(GBU_ID= i.GBU_ID, CNT_BARREDSUBSC_CC= i.Count))
    ...
    try:
        ...
        for i in grp_data:
            session.add(PCC_COMPGAGG_DATA(Group_ID=i.Group_ID, CNT_BARREDSUBSC_CC=i.Count))
    ...
    try:
        ...
        for i in leg_data:
            session.add(PCC_ENTITYAGG_DATA(Entity_ID=i.Entity_ID, CNT_BARREDSUBSC_CC=i.Count))
    ...
    try:
        ...
        for i in crp_data:
            session.add(PCC_CORPAGG_DATA(Corp_ID=i.Corp_ID, CNT_BARREDSUBSC_CC=i.Count))
    ...
    try:
        ...
        for i in cst_data:
            session.add(PCC_CUSTAGG_DATA(Customer_ID=i.Customer_ID, CNT_BARREDSUBSC_CC=i.Count))
